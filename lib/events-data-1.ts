...
export const EVENTS_PART1: WorldEvent[] = [
  ...
  },
  {
    ...
    about:
      "World Environment Day, held on June 5 each year, is the United Nations' principal platform for encouraging environmental awareness and action worldwide. Since its first celebration in 1974, the day has grown into the largest global event for positive environmental action, with millions of participants across every continent. Each year a new theme focuses public attention on an urgent environmental challenge — from plastic pollution and biodiversity collapse to ecosystem restoration, land degradation, and sustainable food systems. A different country hosts the global celebration annually, positioning itself as a hub for world leaders, scientists, NGOs, and citizens to share solutions and make commitments. In 2026, the host country and theme are set against the backdrop of accelerating climate change and a global push to meet the biodiversity targets agreed at the UN Convention on Biological Diversity. World Environment Day complements the wider UN calendar of environmental action — it sits midway between Earth Day in April and major climate and biodiversity summits — creating a sustained season of environmental focus each spring and summer. The day has produced concrete outcomes: from billions of trees planted to international pledges on plastic reduction and marine protection. Your action on June 5, however modest, connects to a planetary-scale story of collective responsibility.",
    history:
